        ...
        <>
            <div
                ...
                onDrop={(e) =>
                    create
                        ? handleDrop(e, refImg)
                        : handleDrop(e, refImg, changeImg, setUserImageSrc)
                }
                ...
                <input
                    ...
                    onInput={(e) =>
                        create
                            ...
                            ? useUploadImg(e, refImg, setImgFile, setInputError, false, true)
                            // eslint-disable-next-line react-hooks/rules-of-hooks
                            : useUploadImg(
                                  e,
                                  refImg,
                ...
                <label className="input-label input-label-img" htmlFor="img">
                    Выберите файл
                </label>
            </div>
            <motion.div
