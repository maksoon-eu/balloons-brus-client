...
const LiItems = observer(
    ({
        ...
        const onPriceInputs = (e) => {
            ...
            setPriceInputs(
                priceInputs.map((item, i) => (i === +e.target.name ? e.target.value : item))
            );
            setInputError(false);
        };
        ...
        const clearAllFilters = () => {
            if (
                !items.itemsLoading &&
                ((items.selectedType && items.selectedSubType) ||
                    Object.keys(items.selectedPrice).length !== 0)
            ) {
                if (priceInputs) {
                    setPriceInputs(['', '']);
                }
            ...
            <motion.li
                ...
                <motion.div
                    ...
                    <motion.div
                        ...
                        {price || subType ? (
                            <div className={`catalog__slide-icon ${isOpen ? 'rotate' : ''}`}>
                                ...
                                {subType ? (
                                        ...
                                        return (
                                            <div
                                                ...
                                                <motion.div
                                                    ...
                                                    <div className="catalog__list-name">
                                                        {item.name}
                                                    </div>
                                                </motion.div>
                                            </div>
                                    ...
                                    <div className="search__group">
                                        ...
                                        <div
                                            ...
                                            style={{
                                                color: inputError ? '#E84D4D' : 'transparent',
                                            }}>
