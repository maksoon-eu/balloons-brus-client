            ...
            <motion.div
                ...
                <div className="market__item-hover">
                    ...
                    <div className="market__item-bottom">
                        <div className="market__item-name" itemProp="name">
                            {item.name.length > 15 ? item.name.slice(0, 15) + '...' : item.name}
                        </div>
                        <div
                            className="market__item-price"
                            itemProp="price">{`${item.price} ₽`}</div>
                        <div className="market__item-group">
                            <div className="market__item-counter">
                                <div
                                    className="market__counter-btn"
                                    onClick={() => calcMinus(flag, items, setCount, item, count)}>
                                    <svg
                                        width="12"
                                        height="12"
                                        viewBox="0 0 10 1"
                                ...
                                <div
                                    className="market__counter-btn"
                                    onClick={() => calcPlus(flag, items, setCount, item, count)}>
                                    <svg
                                        width="12"
                                        height="12"
                                        viewBox="0 0 10 10"
