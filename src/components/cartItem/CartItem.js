            ...
            <div className="cartItem__right">
                ...
                <div className="market__item-group">
                    <div className="market__item-counter">
                        <div className="market__counter-btn" onClick={() => calcMinus(flag, items, setCount, item, count, true)}>
                        ...
                        <div className="market__counter-btn" onClick={() => calcPlus(flag, items, setCount, item, count, true)}>
