            ...
            <motion.div
                ...
                <div className="change__modal-content" ref={refChange}>
                    ...
                    <div className="create__modal-name">
                        ...
                        />
                        <label className="input-label" htmlFor={`name${item.id}`}>
                            Название товара
                        </label>
                    </div>
                    <div className="create__modal-price">
                        <input
                            ...
                            onChange={(e) => useInputsChange(e, setInputError, setInputs)}
                        />
                        <label className="input-label" htmlFor={`price${item.id}`}>
                            Цена товара
                        </label>
                    </div>
                    <div className="create__modal-description">
                        <textarea
                            ...
                            onChange={(e) => useInputsChange(e, setInputError, setInputs)}
                        />
                        <label className="input-label" htmlFor={`description${item.id}`}>
                            Описание товара
                        </label>
                    </div>
